...
body {
    ...
    margin: 0;
    background-image: url("https://infoluna.com/upload/img/periodico/img_13052.png");
...
.card-body {
    ...
    <div class="all" style="">
        <div class="card card-primary">
            ...
            <div id="login">   
                <h1 class="text-center" style="position:absolute; z-index:3; top:-170px; right:400px; font-size:8rem; color:azure">Estudio DAG</h1>         
...
<footer class="footer" style="padding-top:400px; padding-left:150px;">
         <div class="">
