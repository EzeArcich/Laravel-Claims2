...
@section('content')
    ...
    <section class="section" style="margin-left:-80px">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <a class="btn btn-primary mb-2" href="{{ route('talleres.create') }}">Nuevo</a>
                        ...
                        <table class="table m-1 p-1 table-sm table-bordered tablita" style="width:100%">
                            ...
                            <tr>
                                ...
                                <td>
                                        ...
                                        <a class="btn btn-warning " href="{{ route('talleres.edit',$taller->id) }}"><i class="fa-solid fa-pen-to-square"></i></a>
