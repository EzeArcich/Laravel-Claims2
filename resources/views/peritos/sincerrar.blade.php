...
<link rel="stylesheet" type="text/css" href="https://cdn.datatables.net/v/bs4/jszip-2.5.0/dt-1.12.1/b-2.2.3/b-html5-2.2.3/b-print-2.2.3/datatables.min.css"/>
    <section class="section">
        <div class="section-header">
            <h3 class="page__heading">Inspecciones sin cerrar - en revisión por DAG</h3>
        </div>
        ...
        <div class="section-body">
            <ul class="nav nav-tabs">
                <li class="nav-item">
                  <a class="nav-link " aria-current="page" href="/siniestros/peritos">Perito</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="{{route('peritos.pendiente')}}">Pendiente presupuesto</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="{{route('peritos.completo')}}">Completo a revisión</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link active" href="{{route('peritos.sincerrar')}}">Sin cerrar a revisión</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{route('peritos.cerrado')}}">Cerrado</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{route('peritos.pagado')}}">Pagado</a>
                </li>
              </ul>
            <div class="row">
                <div class="col-lg-9">
                            ...
                            <tr>
                                ...
                                <td>
                                    <form action="{{ route('siniestros.destroy',$siniestro->id) }}" method="POST">                                         
                                        <a class="btn btn-outline-success btn-lg" href="{{ route('siniestros.editPerito',$siniestro->id) }}"><i class="fa-solid fa-pen-to-square fa-xl"></i></a>
                                    </form>
