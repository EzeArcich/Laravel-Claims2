...
<link rel="stylesheet" type="text/css" href="https://cdn.datatables.net/v/bs4/jszip-2.5.0/dt-1.12.1/b-2.2.3/b-html5-2.2.3/b-print-2.2.3/datatables.min.css"/>
    <section class="section">
        <div class="section-header">
            <h3 class="page__heading">Inspecciones cerradas</h3>
        </div>
        ...
        <div class="section-body">
            <ul class="nav nav-tabs">
                <li class="nav-item">
                    <a class="nav-link " aria-current="page" onclick="recargar()" href="/siniestros/peritos">En gestión</a>
                  </li>
                  ...
                  <li class="nav-item">
                      <a class="nav-link active" href="{{route('peritos.cerrado')}}">Stro. cerrado</a>
                  </li>
              </ul>
            <div class="row">
                <div class="col-lg-9">
