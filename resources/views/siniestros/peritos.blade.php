...
<link rel="stylesheet" type="text/css" href="https://cdn.datatables.net/v/bs4/jszip-2.5.0/dt-1.12.1/b-2.2.3/b-html5-2.2.3/b-print-2.2.3/datatables.min.css"/>
    <section class="section m-10">
        <div class="section-header" style="width: 29rem;">
            <h3 class="page__heading">Inspecciones en poder del perito</h3>
        </div>
        ...
        <div class="section-body" style="width: 145rem;">
            
            <ul class="nav nav-tabs">
                <li class="nav-item">
                  <a class="nav-link active" aria-current="page" onclick="recargar()" href="#">En gestión</a>
                </li>
                
                <li class="nav-item">
                  <a class="nav-link" href="{{route('peritos.completo')}}">Revisión DAG</a>
                </li>
                
                <li class="nav-item">
                    <a class="nav-link" href="{{route('peritos.cerrado')}}">Stro. cerrado</a>
                </li>
...
//  }
 ...
 function recargar() {
     .tablita.ajax.reload( null, false ); // user paging is not reset on reload
 };
