...
@section('content')
    ...
    <section class="section">
        <div class="section-header">
            <h3 class="page__heading">Ingreso - Cotizaciones</h3>
        </div>
    ...
    <li class="breadcrumb-item active" aria-current="page">Index</li>
        ...
        <div class="section-body">
            <ul class="nav nav-tabs">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="{{Route('siniestros.ausentes')}}" >Ausentes</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="/siniestros/terceros">Terceros</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link active" href="/siniestros/cotizaciones">Sólo a cotizar</a>
                </li>
              </ul>
            <div class="row">
                <div class="col-lg-12">
