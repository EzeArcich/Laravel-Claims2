...
@section('content')
    <section class="section">
        <div class="section-header">
            <h3 class="page__heading">Editar ingreso de siniestro</h3>
        </div>
...
foreach($relaciones as $gestion)
    {
        ...
        <div class='col-lg-6'>
        <div class='card mt-1 text-white' style='font-weight:800;background-color:red; height:7rem;'>
        <div class='card-body'><h5>Atención!</h5><hr>El siniestro {$gestion->siniestro} también tiene la misma patente ({$gestion->patente}); coordinar ambos <a class='float-right' style='text-decoration:none; color:white; font-weight:800' href='/siniestros/$gestion->id/edit'>Ver..</a></div>
            ...
            <div class="row">
                ...
                <div class="col-lg-9">
                    ...
                    <div class="card-header" style="background:linear-gradient(132deg, rgba(2,0,36,1) 0%, rgba(9,51,121,1) 0%, rgba(0,176,255,1) 100%);">
                                <h3 class="mx-auto my-auto" style="color:white">Editar ingreso de siniestro</h3>
                                </div>
                        <div class="card-body">     
                            ...
                            <form action="{{ route('siniestros.update',$siniestro->id) }}" method="POST" id="myForm" enctype="multipart/form-data">
                              @csrf
                              @method('PUT')
                                <div class="row">
                                ...
                                <div class="col-xs-6 col-sm-6 col-md-6">
                                    ...
                                    <div class="col-xs-3 col-sm-3 col-md-3">
                                        ...
                                        <div class="col-xs-6 col-sm-6 col-md-6">
                                          ...
                                          <select class="form-select col-xs-12 col-sm-12 col-md-12" style="width:22.2rem" aria-label="Default select example" id="compania" for="compania" name="compania">
                                            <option selected>{{$siniestro->compania}}</option>
                                        ...
                                        <div class="col-xs-6 col-sm-6 col-md-6">
                                          ...
                                          <div class="input-group mb-2">
                                            <div class="input-group-prepend">
                                              ...
                                              <select class="form-select col-xs-12 col-sm-12 col-md-12" style="width:22.2rem" aria-label="Default select example" id="modalidad" for="modalidad" name="modalidad" value="{{$siniestro->modalidad}}">
                                        ...
                                        <div class="col-xs-6 col-sm-6 col-md-6">
                                            ...
                                            <div class="input-group mb-2">
                                              <div class="input-group-prepend">
                                                ...
                                                <select class="form-select col-xs-12 col-sm-12 col-md-12" style="width:22.8rem"  aria-label="Default select example" id="motivo" for="motivo" name="motivo" value="{{$siniestro->motivo}}">
                                                  <option selected>{{$siniestro->motivo}}</option>
                                        ...
                                        <div class="col-xs-6 col-sm-6 col-md-6">
                                          ...
                                          <div class="input-group mb-2">
                                            <div class="input-group-prepend">
                                              ...
                                              <select class="form-select col-xs-12 col-sm-12 col-md-12" style="width:20.7rem" aria-label="Default select example" id="enviarorden" for="enviarorden" name="enviarorden" value="{{$siniestro->enviarorden}}">
                                                  <option selected>{{$siniestro->enviarorden}}</option>
                                        ...
                                        <div class="col-xs-6 col-sm-6 col-md-6">
                                          ...
                                          <div class="input-group mb-2">
                                            <div class="input-group-prepend">
                                              ...
                                              <select class="form-select col-xs-12 col-sm-12 col-md-12" style="width:25rem" aria-label="Default select example" id="cliente" for="cliente" name="cliente" value="{{$siniestro->cliente}}">
                                                  <option selected>{{$siniestro->cliente}}</option>
                                        ...
                                        <div class="col-xs-3 col-sm-3 col-md-3">
                                            ...
                                            <div class="input-group mb-2">
                                              <div class="input-group-prepend mx-auto">
                                                <a href="{{$siniestro->link}}" class="btn btn-success">Link 2.0</a>
                                              </div>
                                        ...
                                        <div class="col-xs-3 col-sm-3 col-md-3">
                                          ...
                                          <div class="input-group mb-2">
                                            <div class="input-group-prepend mx-auto">
                                              <a href="{{route('siniestros.show',$siniestro->id)}}" class="btn btn-info">Adjuntos</a>
                                            </div>
                                        ...
                                        <div class="col-xs-6 col-sm-6 col-md-6 mt-2">
                                            ...
                                            <div class="input-group mb-2">
                                              ...
                                              <input type="text" name="contacto" class="form-control" id="contacto" value="{{$siniestro->contacto}}">
                                            </div>
                                        </div>
